...
import com.sultonuzdev.pft.presentation.settings.components.ThemeSelector
        ...
        Column(
            ...
            Column(
                ...
                SettingsSection(title = stringResource(R.string.timer_durations)) {
                    ...
                    SettingsSlider(
                        value = uiState.settings.pomodoroCycleLength,
                        onValueChange = { count ->
                            updatePomodorosBeforeLongBreak(count)
                        },
                        ...
                        valueRange = 1f..10f,
                        steps = 9,
                        valueLabel = "${uiState.settings.pomodoroCycleLength}",
                        modifier = Modifier.padding(vertical = 8.dp)
                    )
                }
